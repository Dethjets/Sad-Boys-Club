...
if ( ! function_exists( 'awesome_theme_setup' ) ) :
	...
	function awesome_theme_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'awesome-theme' ),
		) );
...
function awesome_theme_scripts() {
	...
	wp_enqueue_script( 'awesome-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'awesome-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
