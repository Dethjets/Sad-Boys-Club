...
<div class="container pt-5">
	...
	<div class="row">
		<div class="col-md-6 col-lg-4">
			<div class="card mb-3">
				<img class="card-img-top" <iframe width="100%" height="350px" scrolling="no" frameborder="no" allow="autoplay" src="https://www.kuzu.fm/streaming"></iframe> alt="KUZU Radio Stream">
				<div class="card-body">
		...
		<div class="col-md-6 col-lg-4">
			<div class="card mb-3">
				<img class="card-img-top" href= alt="Soundcloud Stream">
				<div class="card-body">
		...
		<div class="col-md-12 col-lg-12">
			<div class="card mb-3">
				<img class="card-img-top" src="<?php echo do_shortcode('[fts_twitter twitter_name=Sad Boys Club tweets_count=6 cover_photo=yes stats_bar=no show_retweets=no show_replies=no]'); ?> " alt="Twitter Stream">
				<div class="card-body">
